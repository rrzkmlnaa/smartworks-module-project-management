  ...
  return (
    <Card>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 0 }}>
        <CardHeader title='Educational Backgrounds' subheader='wwkk' />
          ...
          >
            ...
            <Grid container spacing={6}>
              <Grid item sm={6} xs={12}>
                <CustomTextField fullWidth defaultValue='' label='Institute Name' placeholder='' />
              </Grid>
              <Grid item sm={6} xs={12}>
                <CustomTextField select defaultValue='' fullWidth id='degree-select' label='Degree'>
                  ...
                  <MenuItem value='a'>Associate</MenuItem>
              ...
              <Grid item xs={12} sm={6}>
                <CustomTextField fullWidth defaultValue='' label='Field of Study' placeholder='' />
              </Grid>
              <Grid item xs={12} sm={6}>
                <CustomTextField fullWidth defaultValue='' label='Grade' placeholder='' />
              </Grid>
              <Grid item xs={12} sm={6}>
                <DatePickerWrapper>
                  <DatePicker
