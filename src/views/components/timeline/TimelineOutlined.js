      ...
      <TimelineItem>
        ...
        <TimelineContent sx={{ '& svg': { verticalAlign: 'bottom', mx: 4 } }}>
          ...
          <Box sx={{ mt: 2, display: 'flex', alignItems: 'center' }}>
            <img width={22} height={22} alt='invoice.pdf' src='/assets/images/icons/file-icons/pdf.png' />
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex' }}>
              <Avatar src='/assets/images/avatars/2.png' sx={{ width: '2rem', height: '2rem', mr: 2 }} />
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <Box sx={{ mb: 3, display: 'flex', flexDirection: { sm: 'row', xs: 'column' } }}>
            <ImgShoe width={70} height={70} alt='Shoe img' src='/assets/images/misc/shoe.jpeg' />
            <Box sx={{ ml: { sm: 3, xs: 0 } }}>
              <Box
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Avatar src='/assets/images/avatars/1.png' sx={{ width: '2rem', height: '2rem', mr: 2 }} />
            <Typography variant='body2' sx={{ fontWeight: 500, color: 'text.primary' }}>
              John Doe (Client)
            </Typography>
          </Box>
