...
// Project requets API
export const createTask = async (body, config = {}) => postApiData(endPoint.task, body, config)

export const updateTask = async (id, body, config = {}) => patchApiData(endPoint.task, id, body, config)

export const fetchTask = async (params, onlyData = false) => getApiData(endPoint.task, params, onlyData)

export const fetchTaskDetail = async (id, params, onlyData = false) =>
